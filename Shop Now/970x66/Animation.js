home_animation = (function() {
	...
	{
		//headphone slides in
		TweenLite.to(black_headphone_1, 0.5, {left:620, delay:0});
		//wire slides in	
		TweenLite.to(wire, 0.5, {left:650, delay:0});
		//headphones rotate
		...
		TweenLite.to(black_headphone_1, 1.6, {left: 535,delay:1.2, ease: Expo.easeOut});
		// //blur image fades in
		TweenLite.to(black_headphone_blur_right, .8, {left: 340,opacity:1, delay:1.5, ease: Expo.easeOut});	
			// // //blur fades out
		TweenLite.to(black_headphone_blur_right, .2, {opacity:0, delay:1.68, ease: Expo.easeInOut});
		// // //wire falls off
		TweenLite.to(wire, 4.5, {top:120, left:350, rotationY:180, delay:1.2});	
		// // //backwards headphone fades out
		TweenLite.to(black_headphone_1, 1, {opacity:0, delay:1.6, ease: Expo.easeOut});	
		TweenLite.to(black_headphone_left, 1.6, {opacity:1, delay:1.7, ease: Expo.easeOut});
		TweenLite.to(jbl_logos, 0.5, {opacity:1, delay:1.6});
		TweenLite.to(cta_bottom_rollover, 0.5, {display:"block", delay:1.6});
	...
	{	
		...
		TweenLite.to(black_headphone_left, 1, {left:-400,opacity:0, delay:0 });
		TweenLite.to(white_headphone, 1, {left:440, opacity:1, delay:.5 });

		TweenLite.to(jbl_logos, 0.3, {opacity:0, delay:0});
		TweenLite.to(for_music_text, 0.3, {opacity:0, delay:0});

		TweenLite.to(jbl_everest_logo, 0.8, {opacity:1, delay:0.7 });
