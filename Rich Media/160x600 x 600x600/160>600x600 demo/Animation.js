...
closeBtnEx.onclick = function() {
	...
	document.getElementById("richMedia").innerHTML ='<iframe width="600" height="343" id="player" src="https://www.youtube.com/embed/xata21mVzLs" frameborder="0" allowfullscreen></iframe>';
